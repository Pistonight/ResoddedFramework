...
//0x4813D0
void LegacySaveGame::SaveGameContext::SyncBytes(void *theDest, int theReadSize)
{
...
//0x481470
void LegacySaveGame::SaveGameContext::SyncInt(int &theInt)
{
	if (mReading)
	{
		if (ByteLeftToRead() < 4)
...
//0x4814C0
void LegacySaveGame::SaveGameContext::SyncReanimationDef(ReanimatorDefinition *&theDefinition)
{
	if (mReading)
	{
		int aReanimType;
...
//0x481560
void LegacySaveGame::SaveGameContext::SyncParticleDef(TodParticleDefinition *&theDefinition)
{
	if (mReading)
	{
		int aParticleType;
...
//0x4815F0
void LegacySaveGame::SaveGameContext::SyncTrailDef(TrailDefinition *&theDefinition)
{
	if (mReading)
	{
		int aTrailType;
...
//0x481690
void LegacySaveGame::SaveGameContext::SyncImage(Image *&theImage)
{
	if (mReading)
	{
		ResourceId aResID;
...
//0x481710
void LegacySaveGame::SyncDataIDList(TodList<unsigned int> *theDataIDList,
									SaveGameContext &theContext,
									TodAllocator *theAllocator)
{
	try
	{
...
//0x4817C0
void LegacySaveGame::SyncParticleEmitter(TodParticleSystem *theParticleSystem,
...
//0x481880
void LegacySaveGame::SyncParticleSystem(Board *theBoard,
...
//0x4818F0
void LegacySaveGame::SyncReanimation(Board *theBoard, Reanimation *theReanimation, SaveGameContext &theContext)
{
...
void LegacySaveGame::SyncTrail(Board *theBoard, Trail *theTrail, SaveGameContext &theContext)
{
...
template <typename T>
inline static void SyncDataArray(LegacySaveGame::SaveGameContext &theContext, DataArray<T> &theDataArray)
{
...
//0x4819D0
void LegacySaveGame::SyncBoard(SaveGameContext &theContext, Board *theBoard)
{
...
//0x481CE0
void LegacySaveGame::FixBoardAfterLoad(Board *theBoard)
{
	{
...
//0x481FE0
bool LegacySaveGame::LawnLoadGame(Board *theBoard, const std::string &theFilePath)
{
...
bool LegacySaveGame::LawnSaveGame(Board *theBoard, const std::string &theFilePath)
{
	SaveGameContext aContext;
	aContext.mFailed = false;
