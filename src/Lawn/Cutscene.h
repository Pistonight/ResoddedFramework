...
class CutScene
{
  ...
  public:
	...
	/// @brief Checks whether the given zombie type occupies a 2x2 grid footprint.
	...
	/// @brief Loads and initializes the intro board layout and assets.
	void LoadIntroBoard();
	...
	/// @brief Loads the pool-themed upsell board layout and assets.
	void LoadUpsellBoardPool();

	/// @brief Loads the fog-themed upsell board layout and assets.
	void LoadUpsellBoardFog();

	/// @brief Loads the challenge screen upsell layout and assets.
	void LoadUpsellChallengeScreen();

	/// @brief Loads the roof-themed upsell board layout and assets.
